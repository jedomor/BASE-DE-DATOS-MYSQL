IF NOT EXISTS CREATE DATABASE Boletin_03_Banco;
USE Boletin_03_Banco;
...
/*INICIO EJERCICIOS*/
/*1. Por cada cliente, contar el número de cuentas bancarias que posee sin movimientos. Se deben mostrar los siguientes campos: apellidos, nombre, num_cuentas_sin_movimiento (tomar como base el ejercicio 16 de las consultas de resumen)*/
